...
class ServiceDetails extends React.Component {
  ...
  render() {
    ...
    if (itemListData && itemListData.length > listItemCount) {
        dotString = true;
     }
    if (itemListData && itemListData.length > listItemCount && details) {
       dotString = true;
    } 
...
export default injectIntl(withStyles(s)(ServiceDetails));