            ...
            <div className={'inputFocusColor'}>
                ...
                <form onSubmit={handleSubmit(submit)}>
                    <Panel className={s.panelHeader}
                        ...
                        <div className={s.payoutHeaderNoHorizontalPadding}>
                          <FormattedMessage {...messages.venmoHeader} />
                        </div>
                            ...
                            <div className={s.space4}>
                              <Field name="payPhone" component={this.renderField} label={formatMessage(messages.venmoPhone)} />
                              <Field name="payPhone2" component={this.renderField} label={formatMessage(messages.venmoPhone2)} />
                            </div>
                            <p className={s.payoutIntro}>
                                <FormattedMessage {...messages.venmoHelp} />
                            </p>
...
export default injectIntl(withStyles(s)(connect(mapState, mapDispatch)(Venmo)));