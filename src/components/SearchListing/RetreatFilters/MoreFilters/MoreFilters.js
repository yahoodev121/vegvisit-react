          ...
          isExpand && <div className={s.searchFilterPopoverFull} ref={this.setWrapperRef}>
            <div className={cx(s.searchFilterPopoverContent, s.padding6)}>
              ...
              <CheckboxGroupFilterXs
                className={cx(s.filters, s.spaceTop7, s.space4)}
                isActive={formValues && formValues.category && formValues.category.length > 0}
              ...
              <CheckboxGroupFilterXs
                className={cx(s.filters, s.spaceTop7, s.space4)}
                isActive={formValues && formValues.meal && formValues.meal.length > 0}
