...
class GuestRequirementsTips extends React.Component {
  static propTypes = {
  };
          ...
          <div className={s.helpPanel}>
            <div className={s.helpPanelText}>
              <p>
                ...
                <span><FormattedMessage {...messages.guestRequirementsLabel} /></span>
              </p>
              {/* <p>
...
export default withStyles(s)(GuestRequirementsTips);
