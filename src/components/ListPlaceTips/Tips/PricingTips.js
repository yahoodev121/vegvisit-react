...
class PricingTips extends React.Component {
  static propTypes = {
  };
          ...
          <div className={s.helpPanel}>
            <div className={s.helpPanelText}>
              <p>
                ...
                <span><FormattedMessage {...messages.priceingTips} /></span>
                <br />
                <br />
                <span><FormattedMessage {...messages.priceingSubTips} /></span>
                <br />
                <br />
                <span><FormattedMessage {...messages.pricingCurrencyNote} /></span>
              </p>
              {/* <p>
...
export default withStyles(s)(PricingTips);
