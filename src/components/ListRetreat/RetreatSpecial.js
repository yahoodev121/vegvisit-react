...
class RetreatSpecial extends Component {
  static propTypes = {
  ...
  async onFocus() {
    ...
    await dispatch(change('RetreatForm', 'tipForm', 'RetreatSpecial'));
  }
          ...
          <Col xs={12}>
            <div>
              <h3 className={s.landingContentTitle}>
                <FormattedMessage {...messages.retreatSpecial} />
              </h3>
...
export default injectIntl(
  withStyles(s)(connect(mapState, mapDispatch)(RetreatSpecial))
);
