...
class Itinerary extends Component {
  ...
  async onFocus() {
    ...
    await dispatch(change('RetreatForm', 'tipForm', 'Itinerary'));
  }
    ...
    return (
      <Grid fluid onMouseEnter={() => {this.onFocus()}} onMouseLeave={() => this.onBlur()}>
        <Row className={s.landingContainer}>
          <Col xs={12} >
            <div>
              <h3 className={s.landingContentTitle}>Program (Schedule)/ Sample Itinerary/ Program Highlights</h3>
              <p>Provide a retreat schedule or sample itinerary for those interested to see all the amazing activities ahead if they book your retreat</p>
